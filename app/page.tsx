...
import { Project, WorkExperience, aboutYou, marketingHeadlines, projects, skills, workExperiences } from '@/lib/data';
      ...
      <div className='flex flex-col md:flex-row my-10 mx-10 md:mx-0 space-x-0 md:space-x-10 space-y-10 md:space-y-0 '>
        ...
        <div className='md:min-w-[65vh] min-w-full space-y-10'>
          ...
          <section id='home' key='home' className='space-y-5'>
            <div className='text-2xl font-bold tracking-tight'>{marketingHeadlines.mainHeadline}</div>
            <div className='text-muted-foreground'>{marketingHeadlines.subHeadline}</div>
            <div>
              <Separator />
            </div>
            <div className='flex justify-between md:flex-row flex-col items-center'>
              ...
              <div className='flex flex-col sm:flex-row gap-x-4 w-full mt-6 gap-y-4 sm:mt-0'>
                <div className='space-y-1'>
                  <h3 className='font-medium leading-none whitespace-nowrap'>{aboutYou.yearsOfExperience}</h3>
          ...
          <section id='contact' key='contact'>
            ...
            <div className='mt-5 rounded-xl border bg-card text-card-foreground shadow'>
              <p className='p-6 text-sm text-muted-foreground'>
                Best way to reach me is through: <a href={`mailto:${aboutYou.email}`}>{aboutYou.email}</a>
              </p>
            </div>
          </section>
        </div>
