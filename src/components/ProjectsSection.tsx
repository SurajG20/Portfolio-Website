...
function ProjectArtwork({ index }: { index: number }) {
  if (index === 1) {
    return (
      <div className="relative aspect-4/3 overflow-hidden bg-acid text-foreground" aria-hidden="true">
        <div className="absolute left-[9%] top-[11%] h-[72%] w-[53%] bg-coral" />
          <div className="absolute left-[6%] top-[8%] h-[72%] w-[53%] border-2 border bg-mist p-[7%]">
          <div className="font-display text-[clamp(1.05rem,4vw,2rem)] leading-none">EMPLOYEE</div>
          <div className="mt-[10%] h-[3%] w-[72%] bg-foreground/25" />
          <div className="mt-[6%] flex items-center gap-[5%]">
            <span className="h-[clamp(0.55rem,2vw,0.9rem)] w-[clamp(0.55rem,2vw,0.9rem)] border-2 border-foreground/20 bg-coral" />
            <span className="h-1 w-[62%] bg-foreground/65" />
          </div>
          <div className="mt-[6%] flex items-center gap-[5%]">
            <span className="h-[clamp(0.55rem,2vw,0.9rem)] w-[clamp(0.55rem,2vw,0.9rem)] border-2 border-foreground/20 bg-acid" />
            <span className="h-1 w-[76%] bg-foreground/65" />
          </div>
          <div className="mt-[6%] flex items-center gap-[5%]">
            <span className="h-[clamp(0.55rem,2vw,0.9rem)] w-[clamp(0.55rem,2vw,0.9rem)] border-2 border-foreground/20 bg-coral" />
            <span className="h-1 w-[52%] bg-foreground/65" />
          </div>
          <div className="absolute bottom-[8%] left-[13%] bg-ink px-[6%] py-[3%] font-display text-[clamp(0.65rem,2.4vw,0.95rem)] text-white">
            VALIDATED
          </div>
        </div>
        <div className="absolute left-[61%] top-1/2 h-1 w-[10%] -translate-y-1/2 bg-foreground/15" />
        ...
        <div className="absolute right-[6%] top-[17%] grid w-[21%] gap-[10%]">
          {["API", "PDF", "CSV"].map((format, formatIndex) => (
            <div
              key={format}
              className={`border-2 border-foreground/20 px-[8%] py-[16%] text-center font-display text-[clamp(0.7rem,2.7vw,1.15rem)] ${
  ...
  if (index === 2) {
    return (
      <div className="relative aspect-4/3 overflow-hidden bg-coral text-foreground" aria-hidden="true">
          <div className="absolute left-[7%] top-[9%] h-[68%] w-[76%] border-2 border-foreground/20 bg-mist">
          <div className="flex h-[14%] items-center gap-[2%] border-b-2 border-foreground/20 px-[4%]">
            ...
            <span className="h-[clamp(0.35rem,1.4vw,0.6rem)] w-[clamp(0.35rem,1.4vw,0.6rem)] rounded-full bg-muted-foreground/40" />
          ...
          <div className="grid h-[86%] grid-cols-2 gap-[6%] p-[7%]">
            <div className="border-2 border-foreground/20 bg-acid p-[8%]">
              <div className="aspect-square bg-foreground/15" />
              <div className="mt-[12%] h-1 w-[72%] bg-ink" />
              <div className="mt-[8%] h-1 w-[45%] bg-foreground/40" />
            </div>
            <div className="border-2 border-foreground/20 bg-coral/60 p-[8%]">
              <div className="aspect-square bg-foreground/15" />
              <div className="mt-[12%] h-1 w-[68%] bg-ink" />
              <div className="mt-[8%] h-1 w-[52%] bg-foreground/40" />
            </div>
          </div>
        </div>
          <div className="absolute bottom-[7%] right-[5%] w-[43%] border-2 border-foreground/20 bg-background p-[4%] text-foreground shadow-[-8px_8px_0_0_var(--coral)]">
  ...
  return (
    ...
    >
      <div className="absolute left-[7%] top-[12%] h-[62%] w-[58%] border-2 border-acid bg-coral" />
        <div className="absolute left-[11%] top-[8%] h-[62%] w-[58%] border-2 border-hero-foreground bg-background">
      ...
      <div className="absolute right-[5%] top-[9%] grid w-[23%] gap-2 font-display text-[clamp(0.58rem,2.1vw,0.85rem)] text-foreground">
        ...
        <div className="text-center text-acid">↓</div>
        <div className="bg-mist px-[8%] py-[12%] text-center">PUBLISH</div>
      </div>
