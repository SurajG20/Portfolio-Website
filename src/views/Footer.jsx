...
const Footer = () => {
  return (
    <div className="flex items-center justify-between bg-[#5b75c2] text-black py-2 sm:px-12 lg:px-16 px-8">
      ...
      <div className="flex gap-3">
        ...
        >
          <svg
            className="h-8 w-8 text-[#d6c48f] hover:text-gray-900 transition-colors fill-current"
            focusable="false"
            aria-hidden="true"
            viewBox="0 0 24 24"
